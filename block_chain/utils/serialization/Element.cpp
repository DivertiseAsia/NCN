...
void ElementDouble::read(std::string& text, const ContentReader* parser)
{
    parser->parseContent(text, this);
}

void ElementString::read(std::string& text, const ContentReader* parser)
{
    parser->parseContent(text, this);
}

void ElementBoolean::read(std::string& text, const ContentReader* parser)
{
    parser->parseContent(text, this);
}

void ElementArray::read(std::string& text, const ContentReader* parser)
{
    parser->parseContent(text, this);
}
...
void ElementObject::read(std::string& text, const ContentReader* parser)
{
    parser->parseContent(text, this);
}
